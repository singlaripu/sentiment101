...
FDATA_FILE = "./webapp/reduceddata.pickle"


# def negate_sequence(text, pos, neg, totals):
...
def classify2(text):
    ...
    words = set(word for word in negate_sequence(text, pos, neg, totals) if word in pos or word in neg)
